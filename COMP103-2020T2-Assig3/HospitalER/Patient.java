...
public class Patient implements Comparable<Patient>{
    ...
    //challenge
    private int totalERwaitingTime;
    private int totalERTreatmentTime;
    ...
    public Patient(int time, int triPriority){
        ...
        currentTreatment = 0; 
        //TODO CHALLENGE.. more stats?
        currentTreatment = 0; 
        totalERwaitingTime = 0;
        totalERTreatmentTime = 0;
    }

    public int getTotalERwaitingTime() {
        return totalERwaitingTime;
    }

    public int getTotalERTreatmentTime() {
        return totalERTreatmentTime;
    }
    ...
    public void waitForATick(){
        totalWaitTime++;
        if (this.getCurrentTreatment().equals("ER")) {
            totalERwaitingTime++; //for logging stats
        }
    }
    ...
    public void advanceTreatmentByTick(){
        ...
        totalTreatmentTime++;
        if (this.getCurrentTreatment().equals("ER")) {
            totalERTreatmentTime++; //for logging stats
        }
     ...
     * Return true if the patient has completed all their treatments.
     */
    public boolean noMoreTreatmentsCompletion(){
        return (currentTreatment >= treatments.size()-1);
    ...
    public int compareTo(Patient other){
        if (this.priority > other.priority) return 1;
            ...
            else if (this.arrival > other.arrival) return -1;
            else return 0;
        }
    }
